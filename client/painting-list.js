...
const setEditModal = (id) => {
    ...
    xhttp.open('GET', `https://art-gallery-api-dwu.herokuapp.com/gallery/${id}`, false);
    xhttp.send();
    ...
    document.getElementById('editForm').action = `https://art-gallery-api-dwu.herokuapp.com/gallery/${id}`;
...
const deletePainting = (id) => {
    ...
    xhttp.open("DELETE", `https://art-gallery-api-dwu.herokuapp.com/gallery/${id}`, false);
    xhttp.send();
...
const loadGallery = () => {
    ...
    xhttp.open("GET", "https://art-gallery-api-dwu.herokuapp.com/gallery", false);
    xhttp.send();
